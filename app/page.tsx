...
const cardClass = "glass-card rounded-3xl p-4 sm:p-6 lg:p-8";
const subCardClass = "section-card rounded-2xl p-3 sm:p-4";
...
export default function HomePage() {
  ...
  return (
    <main className="mx-auto max-w-[1500px] px-3 py-5 sm:px-5 sm:py-8 lg:px-10 lg:py-12">
      <div className="relative overflow-hidden rounded-3xl border border-indigo-200/70 bg-gradient-to-r from-slate-100 via-white to-indigo-100 p-5 text-slate-900 shadow-[0_30px_90px_-35px_rgba(51,65,85,0.32)] sm:p-7 lg:p-8">
        ...
        <div className="relative">
          ...
          <h1 className="mt-4 text-2xl font-bold tracking-tight sm:text-3xl lg:text-4xl">Research Generator</h1>
          <p className="mt-3 max-w-2xl text-xs text-slate-700/90 sm:text-sm">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 sm:gap-5">
            ...
            <div className="flex items-end gap-3 sm:col-span-2 lg:col-span-1">
              <button
                ...
                className="premium-btn w-full rounded-xl px-5 py-2.5 text-sm font-semibold text-white transition hover:scale-[1.01] hover:brightness-105 disabled:cursor-not-allowed disabled:opacity-55"
              >
              ...
              <button
                type="button"
                onClick={onReset}
                className="muted-btn w-full rounded-xl px-5 py-2.5 text-sm font-semibold text-slate-700 transition"
              >
                Reset
              </button>
            </div>
      ...
      {report && (
        <section className={`mt-6 space-y-6 ${cardClass}`}>
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <h2 className="text-xl font-bold text-slate-900 sm:text-2xl">Generated Report</h2>
          ...
          <div className={subCardClass}>
            ...
            <div className="mt-3 grid grid-cols-1 gap-2 text-sm text-slate-700 sm:grid-cols-3 sm:gap-4">
              <p>
